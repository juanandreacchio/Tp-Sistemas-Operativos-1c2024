...
void liberar_recursos(uint32_t pid)
{
    ...
    t_dictionary *recursos_asignados = dictionary_get(recursos_asignados_por_proceso, string_itoa(pid));
...
void retener_instancia_de_recurso(char *nombre_recurso, uint32_t pid)
{
    ...
    t_dictionary *recursos = dictionary_get(recursos_asignados_por_proceso, string_itoa(pid));
